...
export default function ProjectsSection() {
  return (
    <section id="projects" className="py-16 px-4 sm:px-6 lg:px-8 bg-gray-900 scroll-mt-8">
    ...
    >
      ...
      <div className="p-6 flex flex-col flex-grow">
        ...
        <button
          ...
          className="w-full py-2 bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-lg hover:from-blue-700 hover:to-purple-700 transition-all duration-300 mt-auto"
        >
          View Project
        </button>
      </div>
